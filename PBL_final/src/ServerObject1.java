...
public class ServerObject1 implements Runnable {

	ArrayList<Service> Svs;
	ArrayList<Service> Svs2;
	public String serverUrl = "rmi://localhost:2000/Server2000";
	public String serverUrl1 = "rmi://localhost:2001/Server2001";
	public String serverUrl2 = "rmi://localhost:2002/Server2002";
	int port = 2000;
	int num_Server;
	static int priority;
	Service stub;
	public ServerObject1() throws RemoteException, MalformedURLException, NotBoundException {
		register(port);
		Svs = new ArrayList<>();
		Svs2 = new ArrayList<>();
		stub = stub = (Service)Naming.lookup(this.serverUrl);
		num_Server = 1;
		stub.serSname("Server 1");
		stub.setHistory("-----------------Server 1------------------\n");
		priority = 0;
	}
	...
	public static void main(String[] args) throws RemoteException, MalformedURLException, NotBoundException {
		Thread t = new Thread(new ServerObject1());
